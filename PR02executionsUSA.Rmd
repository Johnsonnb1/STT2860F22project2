...
* Item 1:There are three states where the death penalty is in flux.
* Item 2: Of the remaining states half are for the death penalty and the other half are against it. 

#### Plot #2

* Item 1: The Midwest is split about half-and-half in their views on the death penalty. 
* Item 2: The Northeast is mostly against the death penalty with a small percentage that says yes, in moratorium. 

#### Plot #3

* Item 1: This shows us the number of prisoners on death row and we can see that it peaks around 2000. 
* Item 2 From this graph we can see that it has steadily decreased since the year 2000.

#### Plot #4

* Item 1: The extreme outlier of this plot is the state Texas.
* Item 2: The data is very skewed to the right because there are a lot of states that have very little executions.

#### Plot #5

* Item 1: We see a peak in the data between the years 1990 and 2000. 
* Item 2: The number of sentences have decreased since the year 2001, however the decrease is not constant. 
